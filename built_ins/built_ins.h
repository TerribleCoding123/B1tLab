...
namespace BuiltIns {
	...
	*/
	...
	inline std::string kMaxBin{ "1111111111111111111111111111111111111111111111111111111111111111" };
	...
	namespace InpHandling {
		...
		Value valueParser(std::string input, std::string num_sys, std::string min_int_num, std::string max_int_num, uint64_t max_frac_digit_amount = kMaxMantissa, bool remove_leading_zeroes = true, bool remove_trailing_zeros = true, bool include_neg_zero = false);
